  ...
  <div>
    <div class="photoshop">
      ...
      <CorrectionModal
        ...
        :nowH="this.nowH"
        :startImage="this.startImage"
        :showCorrectionModal="this.showCorrectionModal"
        ref="curves"
        v-show="showCorrectionModal"
      />
      <FilteringModal
...
export default {
  ...
  methods: {
    ...
    handleMouseMove(e) {
      this.x = e.offsetX;
      this.y = e.offsetY;
      if (this.isDragging && this.state == "arm") {
    ...
    changeCurves() {
      ...
      this.showCorrectionModal = !this.showCorrectionModal;
      this.showPippetModal = false;
      this.showFilterModal = false;
    },
    changeFiltering() {
